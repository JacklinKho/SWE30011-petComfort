...
from pigGlobalMQTT import pigGlobalMQTT
...
def take_image():
    try:
        ...
        # Set takePhoto_pig to FALSE in the database
        update_takephoto_query = "UPDATE Picam_Table SET takePhoto_pig = FALSE WHERE piCamID = 1"
        cloudCursor.execute(update_takephoto_query)
        print("takePhoto_pig set to FALSE.")

        cloudDB.commit()
        print("Database commit successful.")

        return {"message": "Image captured and stored in the database. takePhoto_pig set to FALSE."}
...
def process_data():
    ...
    while True:
        ...
        localCursor.execute("""INSERT INTO Pig_Raw_Data (petCount, humidity, lightState, temperature_C, temperature_F, fanState, fanSpeed, windowState, 
